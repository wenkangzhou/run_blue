...
import { generateTrainingPlan, TrainingPlanInputError } from '@/lib/ai';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { distance, targetTimeSeconds, weeks, pb5kSec, weeklyVolume, raceDate, locale } = parsed.payload;
